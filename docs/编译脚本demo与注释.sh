...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-jni"                          # java支持， 
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-mediacodec"                   # 硬解？
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-decoder=h264_mediacodec"      # 硬解模式
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-hwaccel=h264_mediacodec"      # 硬件加速
    # --enable-jni \
# --enable-mediacodec \
