...
#pragma warning(disable: 4996)  // 不显示 xx号警告
...
int main(int argc, char *argv[])
{
    ...
    avpicture_fill((AVPicture*)g_pFrameYUV, out_buffer, AV_PIX_FMT_YUV420P, pCodecCtx->width, pCodecCtx->height);
    ...
    printf("pCodecCtx->pix_fmt  %d", pCodecCtx->pix_fmt);
